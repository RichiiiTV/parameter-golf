...
try:
    ...
    from .byte_scoring import build_sentencepiece_luts as shared_build_sentencepiece_luts, token_byte_counts
    from .configs import get_config
    from .runtime_inputs import ensure_local_runtime_inputs
except ImportError:
    from architectures import HybridGDN, CastedLinear
    from byte_scoring import build_sentencepiece_luts as shared_build_sentencepiece_luts, token_byte_counts
    from configs import get_config
...
class Hyperparameters:
    ...
    eval_compile_enabled = bool(int(os.environ.get("EVAL_COMPILE_ENABLED", "0")))
...
def build_sentencepiece_luts(sp, vocab_size, device):
    return shared_build_sentencepiece_luts(sp, vocab_size, device)
